...
```
cd existing_repo
git remote add origin https://gitlab.com/gbpkk/gbpcloudmonitor-back.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/gbpkk/gbpcloudmonitor-back/-/settings/integrations)
